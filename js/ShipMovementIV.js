...
var g_shipMovementIV = new ShipMovementIV();
g_shipMovementIV.Start();
//--------------------------------------------------------------------

function ShipMovementIV() {
    ...
    //--------------------------------------------------------------------
    this.Start = function () {
        m_canvas = m_shell.GetCanvas("cvsShipMovementIV");
        if (m_canvas) {
    ...
    function Space() {
        ...
        this.Init = function () {
            ...
            m_playerImg.src = "https://sites.google.com/site/ahewe95/sora_shooting_game/player_roll.png";
            m_playerRadius = 32;
        ...
        this.Update = function () {
            ...
            } else if (right && (m_playerPosition.x + m_playerRadius) <= m_canvas.width) {
                m_playerPosition.x += g_shipSpeed;
            }

            this.m_rollShip(left, right);
        };
        //--------------------------------------------------------------------
        this.m_rollShip = function (left, right) {
            if (!left && !right) {
                if (m_roll < 0)
                    m_roll++;
                else if (0 < m_roll)
                    ...
                    return;
            } else if (left && -20 < m_roll) {
                m_roll--;
            } else if (right && m_roll < 20) {
                m_roll++;
            } else {
                return;
            }

            if (-20 <= m_roll && m_roll < -15) {
                m_textureX = 0;
            } else if (-15 <= m_roll && m_roll < -5) {
                m_textureX = 32;
            } else if (-5 <= m_roll && m_roll <= 5) {
                m_textureX = 64;
            } else if (5 < m_roll && m_roll <= 15) {
                m_textureX = 96;
            } else if (15 < m_roll && m_roll <= 20) {
                m_textureX = 128;
            }
        }
        //--------------------------------------------------------------------
        this.Draw = function () {
            ...
            m_context.drawImage(m_playerImg, m_textureX, 0, 32, 32, m_playerPosition.x, m_playerPosition.y, 32, 32);
        };
        //--------------------------------------------------------------------
    };
    //--------------------------------------------------------------------
